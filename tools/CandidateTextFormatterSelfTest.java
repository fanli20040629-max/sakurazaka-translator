...
public final class CandidateTextFormatterSelfTest {
    public static void main(String[] args) {
        ...
        String result = CandidateTextFormatter.format(fragments, selected);
        check("第一行～\n第三行".equals(result), "selection must follow OCR screen order");
        check("".equals(CandidateTextFormatter.format(null, selected)),
                "null inputs must produce empty output");
        System.out.println("CandidateTextFormatterSelfTest PASS");
    }
