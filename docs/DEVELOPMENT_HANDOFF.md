...
> 2026-09-16：本轮交接先读 [本轮优化验收与交接](本轮优化验收与交接.md) 和 [当前代码审核与改进方案](当前代码审核与改进方案.md)。本文件下方 A1～A5 指令及环境路径为历史资料，不能视为本轮已经构建/安装的证明。不要重新复制 handoff/core_modules 的同名类覆盖本轮实现。
